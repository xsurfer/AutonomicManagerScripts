...
int select_warehouse() { //1 warehouse
	return TPCC_ITEMS + TPCC_WAREHOUSES * (TPCC_STOCKS_PER_WAREHOUSE
															+TPCC_DISTRICTS_PER_WAREHOUSE
																+(TPCC_DISTRICTS_PER_WAREHOUSE*(TPCC_CUSTOMERS_PER_DISTRICT+TPCC_ORDERS_PER_DISTRICT
																		+(TPCC_ORDERS_PER_DISTRICT*TPCC_ORDER_LINE_PER_ORDER))));
}
