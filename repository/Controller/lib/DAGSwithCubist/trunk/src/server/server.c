...
void commit_distributed_transaction(state_type *state, transaction_metadata *transaction, event_content_type * event_content, time_type now) {
	//execute local commit
	commit_local_transaction(state, event_content, now);
	//send final commit messages to other servers
	send_final_commit_messages(state, transaction, event_content, now);
}
...
void abort_distributed_transaction(state_type *state, transaction_metadata *transaction, event_content_type * event_content, time_type now) {
	//before execute local abort
	abort_local_transaction(state, event_content, now);
	//send final abort messages to other servers
	send_final_abort_messages(state, transaction, event_content, now);
}
